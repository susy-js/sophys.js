...
export declare type CosrceFunc = (type: string, value: any) => any;
...
export declare const defaultCosrceFunc: CosrceFunc;
...
export declare class AbiCoder {
    readonly coerceFunc: CosrceFunc;
    constructor(coerceFunc?: CosrceFunc);
